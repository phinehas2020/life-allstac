...
import { Calendar, Users, Upload, ArrowLeft, Bell, BellOff, Share2, Link as LinkIcon, Check } from "lucide-react"
    ...
    if (navigator.share) {
      try {
        await navigator.share({
          title: event?.name,
          text: event?.description || `Check out ${event?.name} on Life.Allstac`,
